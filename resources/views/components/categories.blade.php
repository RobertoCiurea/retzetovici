<div id="categories" class="flex flex-col items bg-gradient-to-b gap-5 from-accentLight to-accent px-5 py-10 items-center justify-center md:items-start  lg:mx-[20rem] rounded-b-lg ">
<h1 class="text-2xl md:text-4xl text-white font-kanit font-bold md:px-5">Categorii</h1>

<div class="grid grid-cols-1 sm:grid-cols-2 w-full grid-flow-row items-start gap-10 justify-items-center 2xl:grid-cols-3 ">
